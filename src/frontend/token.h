#pragma once // pragma is used for header guards, to prevent multiple inclusions of the same header
			 // file
...
// tells us the size of the line of hte code and gives the locaitons and the start as well
